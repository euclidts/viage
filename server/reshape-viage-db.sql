...
UPDATE Account SET Zip = NULL WHERE Zip = '';
...
ADD PRIMARY KEY (Id),
MODIFY Id INT AUTO_INCREMENT,
MODIFY Category MEDIUMINT UNSIGNED,
MODIFY Extension VARCHAR(4),
MODIFY FileName VARCHAR(63),
MODIFY RelativePath VARCHAR(255),
MODIFY IsUploaded BOOLEAN,
MODIFY UploadDate DATE,
MODIFY AccountId INT NOT NULL,
ADD CONSTRAINT FOREIGN KEY (AccountId) REFERENCES Account (Id),
MODIFY IsProcessed BOOLEAN;

UPDATE SummaryLink SET CreationDate = NULL WHERE CreationDate = '';
UPDATE SummaryLink SET DownloadDate = NULL WHERE DownloadDate = '';

ALTER TABLE SummaryLink
ADD PRIMARY KEY (Id),
MODIFY Id UUID,
MODIFY CreationDate DATE,
MODIFY EMail VARCHAR(127),
MODIFY DownloadDate DATE,
MODIFY AccountId INT NOT NULL,
ADD CONSTRAINT FOREIGN KEY (AccountId) REFERENCES Account (Id);

DELETE FROM BaseDefinition WHERE Id = 2;

ALTER TABLE BaseDefinition DROP COLUMN Id;
